...
interface NewsletterBlogNoCtaEmailProps {
  firstName: string;
  language: 'es' | 'en';
  blogTitle: string;
  blogExcerpt: string;
...
const copy = {
  es: {
    ...
    intro: 'Acabamos de publicar un nuevo artículo que puede ser de tu interés:',
    metaBy: 'Por',
    metaRead: 'de lectura',
    readArticle: 'Leer el artículo completo',
    softNote:
      'Si ya estás trabajando con nosotros, mantén contacto con el abogado asignado a tu caso para cualquier duda específica sobre tu situación.',
  ...
  en: {
    ...
    intro: 'We just published a new article that may be of interest to you:',
    metaBy: 'By',
    metaRead: 'read',
    readArticle: 'Read the full article',
    softNote:
      'If you are already working with us, stay in contact with the attorney assigned to your case for any specific questions about your situation.',
...
export function NewsletterBlogNoCtaEmail({
  firstName,
  language = 'es',
  blogTitle,
  blogExcerpt,
...
export default NewsletterBlogNoCtaEmail;
