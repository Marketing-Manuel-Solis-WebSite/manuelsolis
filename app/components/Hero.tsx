...
export default function HeroProfessional() {
  ...
  return (
    <section 
      ref={containerRef}
      className={`relative min-h-screen w-full flex flex-col justify-center bg-[#001540] overflow-hidden ${font.className} pt-24 lg:pt-44 pb-48 lg:pb-72`}
    >
      {/* Background Effects */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden transform-gpu">
        ...
        >
            <span className={`text-[80vh] lg:text-[160vh] leading-none font-extrabold italic text-white tracking-tighter mix-blend-overlay transform -skew-x-12 ${font.className}`}>
                  N/\И/\
            </span>
        </motion.div>
      ...
      <div className="container mx-auto px-4 lg:px-12 relative z-10 flex-grow flex flex-col justify-center">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-6 lg:gap-12 items-center">
          ...
          <motion.div 
            className="lg:col-span-5 w-full relative h-[350px] sm:h-[450px] lg:h-[750px] flex items-end justify-center perspective-[1000px]"
          >
            ...
            >
               <div className="w-full h-full scale-110 sm:scale-125 lg:scale-[1.5] lg:-translate-x-24 lg:origin-bottom transition-transform duration-1000 transform-gpu">
          ...
          {/* Text Content Section - Optimized for Mobile */}
          <div className="lg:col-span-7 w-full space-y-6 lg:space-y-10 pl-0 lg:pl-16 relative z-20">
            ...
            >
              ...
              <div className="relative flex flex-col items-center lg:items-start overflow-visible">
                ...
                {/* 50,000 Number - Mobile Optimized */}
                <div className="relative w-full overflow-visible px-2 sm:px-4 lg:px-4 lg:pr-16 py-2 sm:py-4">
                  ...
                  {isDesktop && (
                    <motion.div
                        className="absolute inset-0 text-[3.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[10rem] font-black tracking-tighter flex items-center justify-center lg:justify-start pointer-events-none w-full px-2 sm:px-4 lg:px-4 lg:pr-16 py-2 sm:py-4"
                        style={{
                ...
                >
                  <div className="relative inline-block">
                    ...
                    <motion.div
                      className="absolute inset-0 text-lg sm:text-xl md:text-2xl lg:text-3xl uppercase tracking-[0.3em] sm:tracking-[0.4em] font-light blur-sm"
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 w-full border-t border-white/5 bg-transparent pt-8 sm:pt-12 pb-16 sm:pb-24">
        <div className="relative w-full overflow-hidden mask-linear-fade">
           ...
           <motion.div 
             className="flex items-center gap-40 sm:gap-80 whitespace-nowrap" 
      ...
      {/* Detained Relative Popup - Mobile Optimized */}
      {showPopup && (
        <motion.div
