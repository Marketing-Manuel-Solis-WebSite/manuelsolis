...
export const LANDING_PAGES: LandingPageConfig[] = [
  // === IMMIGRATION (8 cities) ===
  {
    ...
    metaDescription: {
      es: 'Abogados de inmigración en Houston: residencia, ciudadanía, deportación, Visa U, VAWA y asilo. 2 oficinas presenciales y 4 satelite. Llame: (713) 701-1731.',
      en: 'Immigration lawyers in Houston: residency, citizenship, deportation, U Visa, VAWA and asylum. 2 walk-in offices and 4 satellite. Call: (713) 701-1731.',
    },
    intro: {
      es: 'Houston es el hogar de una de las comunidades inmigrantes más grandes de Estados Unidos. En Manuel Solís, hemos representado a miles de familias del área metropolitana de Houston desde 1990. Con dos oficinas de atencion presencial en la ciudad —Navigation Blvd y Bellaire Blvd— y cuatro sedes satelite que atienden con visita coordinada, estamos cerca de usted para ofrecer asesoría legal migratoria personalizada. Nuestro equipo bilingüe entiende los desafíos únicos que enfrentan los inmigrantes en el área de Houston y trabaja incansablemente para proteger sus derechos.',
    ...
    whyChooseUs: {
      es: ['2 oficinas presenciales en Houston y 4 satelite', 'Equipo bilingüe con experiencia en cortes de inmigración de Houston', 'Historial comprobado: miles de casos de inmigración ganados en el área', 'Relaciones establecidas con agencias locales y consulados', 'Atención personalizada y confidencial'],
      en: ['2 walk-in offices in Houston plus 4 satellite locations', 'Bilingual team experienced in Houston immigration courts', 'Proven track record: thousands of immigration cases won in the area', 'Established relationships with local agencies and consulates', 'Personalized and confidential attention'],
    },
  },
  {
