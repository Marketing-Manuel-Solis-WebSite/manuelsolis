...
export const LANDING_PAGES: LandingPageConfig[] = [
  // === IMMIGRATION (8 cities) ===
  {
    ...
    metaDescription: {
      es: 'Abogados de inmigración en Houston: residencia, ciudadanía, deportación, Visa U, VAWA y asilo. 3 oficinas presenciales y 4 satélite. Llame: (713) 701-1731.',
      en: 'Immigration lawyers in Houston: residency, citizenship, deportation, U Visa, VAWA and asylum. 3 walk-in offices and 4 satellite. Call: (713) 701-1731.',
    },
    intro: {
      es: 'Houston es el hogar de una de las comunidades inmigrantes más grandes de Estados Unidos. En Manuel Solís, hemos representado a miles de familias del área metropolitana de Houston desde 1990. Con tres oficinas de atención presencial en la ciudad —dos en Navigation Blvd y una en Bellaire Blvd— y cuatro sedes satélite que atienden con visita coordinada, estamos cerca de usted para ofrecer asesoría legal migratoria personalizada. Nuestro equipo bilingüe entiende los desafíos únicos que enfrentan los inmigrantes en el área de Houston y trabaja incansablemente para proteger sus derechos.',
    ...
    whyChooseUs: {
      es: ['3 oficinas presenciales en Houston y 4 satélite', 'Equipo bilingüe con experiencia en cortes de inmigración de Houston', 'Historial comprobado: miles de casos de inmigración ganados en el área', 'Relaciones establecidas con agencias locales y consulados', 'Atención personalizada y confidencial'],
      en: ['3 walk-in offices in Houston plus 4 satellite locations', 'Bilingual team experienced in Houston immigration courts', 'Proven track record: thousands of immigration cases won in the area', 'Established relationships with local agencies and consulates', 'Personalized and confidential attention'],
    },
  },
  {
  ...
  // === ACCIDENTS (2 cities) ===
  {
    ...
    intro: {
      es: 'Houston es una de las ciudades con más accidentes de tránsito en Texas debido a su extenso sistema de autopistas y el alto volumen de tráfico de camiones comerciales. Si usted o un ser querido ha sido víctima de un accidente en el área de Houston, nuestro equipo legal está listo para luchar por la compensación que merece. No cobramos a menos que ganemos su caso. Con tres oficinas presenciales y cuatro satélite en Houston, estamos cerca de usted cuando mas nos necesita.',
      en: 'Houston is one of the cities with the most traffic accidents in Texas due to its extensive highway system and high volume of commercial truck traffic. If you or a loved one has been a victim of an accident in the Houston area, our legal team is ready to fight for the compensation you deserve. We don\'t charge unless we win your case. With three walk-in offices and four satellite locations in Houston, we are close to you when you need us most.',
    },
    whyChooseUs: {
