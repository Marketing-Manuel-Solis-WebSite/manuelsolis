...
export default function AttorneyProfile({ slug, lang }: AttorneyProfileProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#001529] text-white relative selection:bg-[#B2904D] selection:text-white font-sans overflow-x-hidden">
      ...
      {/* FONDO ATMOSFERICO - CSS only, no JS animations — orbes solo desde lg, como OfficePageView: dos blur de 150/180px sobre una capa fija a pantalla completa coinciden con LCP de 15-28 s en iOS en estas páginas (Speed Insights, sep-2026) */}
