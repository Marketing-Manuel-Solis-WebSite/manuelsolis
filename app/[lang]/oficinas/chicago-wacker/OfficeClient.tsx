...
/**
 * Chicago (S Wacker Dr) — dirección virtual del área de Chicago.
 *
...
const officeData: OfficeData = {
  ...
  city: nap.city,
  state: nap.state,
  title: { es: 'Chicago (S Wacker Dr)', en: 'Chicago (S Wacker Dr)' },
  quote: {
