...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? `Abogados en Naperville (Wall St)`
    : `Lawyers in Naperville (Wall St)`;
  ...
  const schemaData = await buildOfficeSchema(
    {
      ...
      description: {
        es: `Dirección de Manuel Solís en ${nap.city} (Wall St) que se atiende solo con cita previa, sin personal del despacho en el sitio. Inmigración, familia y accidentes.`,
        en: `Manuel Solis by-appointment location in ${nap.city} (Wall St), with no firm staff on site. Immigration, family law, and accident cases.`,
      },
    },
    localeLang,
  );
