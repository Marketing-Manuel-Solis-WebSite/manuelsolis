...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? `Abogados en Park Ridge (Prospect Ave)`
    : `Lawyers in Park Ridge (Prospect Ave)`;
  ...
  const schemaData = await buildOfficeSchema(
    {
      ...
      description: {
        es: `Dirección de Manuel Solís en ${nap.city} (Prospect Ave) que se atiende solo con cita previa, sin personal del despacho en el sitio. Inmigración, familia y accidentes.`,
        en: `Manuel Solis by-appointment location in ${nap.city} (Prospect Ave), with no firm staff on site. Immigration, family law, and accident cases.`,
      },
    },
    localeLang,
  );
