...
const SLUG = 'chicago-prospect';

/**
 * Park Ridge (Prospect Ave) — dirección virtual del área de Chicago.
 *
...
const officeData: OfficeData = {
  ...
  city: nap.city,
  state: nap.state,
  title: { es: 'Park Ridge (Prospect Ave)', en: 'Park Ridge (Prospect Ave)' },
  quote: {
