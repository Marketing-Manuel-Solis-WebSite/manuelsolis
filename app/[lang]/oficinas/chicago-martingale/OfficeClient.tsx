...
/**
 * Schaumburg (Martingale Rd) — dirección virtual del área de Chicago.
 *
...
const officeData: OfficeData = {
  ...
  city: nap.city,
  state: nap.state,
  title: { es: 'Schaumburg (Martingale Rd)', en: 'Schaumburg (Martingale Rd)' },
  quote: {
