...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = isEs
    ? `Abogados en Schaumburg (Martingale Rd)`
    : `Lawyers in Schaumburg (Martingale Rd)`;
  ...
  const schemaData = await buildOfficeSchema(
    {
      ...
      description: {
        es: `Dirección de Manuel Solís en ${nap.city} (Martingale Rd) que se atiende solo con cita previa, sin personal del despacho en el sitio. Inmigración, familia y accidentes.`,
        en: `Manuel Solis by-appointment location in ${nap.city} (Martingale Rd), with no firm staff on site. Immigration, family law, and accident cases.`,
      },
    },
    localeLang,
  );
