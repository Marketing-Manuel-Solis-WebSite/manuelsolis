...
const officeData = {
  ...
  mapLink: 'https://share.google/R85nYwhTFqoxLctD4', // URL PROPORCIONADA
  ...
  posterImage: '/offices/ofhouston.png',
  services: [
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#B2904D]/10 border border-[#B2904D]/30 mb-6">
                  ...
                  <span className="text-[#B2904D] text-xs font-bold tracking-[0.2em] uppercase">Houston (Kirby), Texas</span>
                </div>
              ...
              {/* Video Hero (Si no hay video, usar imagen estática con estilo de video) */}
              <motion.div 
