...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'es': `https://www.manuelsolis.com/es/oficinas/airways`,
        'en': `https://www.manuelsolis.com/en/oficinas/airways`,
        'x-default': `https://www.manuelsolis.com/en/oficinas/airways`,
      },
    },
    openGraph: {
      title,
...
export default async function AirwaysPage({ params }: Props) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: 'Memphis Airways', url: `/${lang}/oficinas/airways` },
  ]);
