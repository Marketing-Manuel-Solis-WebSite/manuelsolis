...
const officeData = {
  ...
  address: '16510 Northchase Dr, Houston, Texas 77060, United States',
  phone: '+1 346-522-4848',
  email: 'houston@manuelsolis.com',
  hours: { es: 'Abierto 24 horas', en: 'Open 24 hours' },
  mapLink: 'https://share.google/wSptYM5hcuGigC3aS', // URL CORRECTA DE GMB
  ...
  posterImage: '/offices/ofNorth.png',
  services: [
  ...
  attorneys: [
    { 
      name: 'Manuel Solís', 
      role: { es: 'Abogado Principal', en: 'Principal Attorney' }, 
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#B2904D]/10 border border-[#B2904D]/30 mb-6">
                  ...
                  <span className="text-[#B2904D] text-xs font-bold tracking-[0.2em] uppercase">Houston (Northchase), Texas</span>
                </div>
