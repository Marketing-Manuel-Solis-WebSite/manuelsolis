...
const officeData = {
  ...
  mapLink: 'https://share.google/Fc3ISgQAihcayfmws', // URL GMB Correcta
  videoUrl: 'https://manuelsolis.com/wp-content/uploads/2023/12/houston-main.mp4',
  posterImage: '/offices/ofAirways.png',
  services: [
  ...
  // --- GERENCIA (SOLO TEXTO) ---
  managers: [
    { name: 'Michelle Magdonald', role: { es: 'Asistente Legal', en: 'Legal Assistant' } }
  ],
  // --- ABOGADOS (LISTA CON IMÁGENES) ---
  attorneys: [
    { 
      name: 'Sara James', // CORREGIDO: James, no Jones
      role: { es: 'Abogada', en: 'Attorney' }, 
      image: 'https://uenjwzjx3vckezns.public.blob.vercel-storage.com/Sara%20James.png', // URL de Vercel Blob correcta para Sara James
