    ...
    <>
      ...
      <main className={`relative w-full min-h-screen bg-[#001540] overflow-hidden ${font.className}`}>
        ...
        <div className="fixed inset-0 z-0 pointer-events-none transform-gpu">
          ...
          {isMobile && (
             <>
                <div className="absolute top-[-10%] right-[-10%] w-[80vw] h-[80vw] bg-blue-600/10 rounded-full blur-[100px]" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[80vw] h-[80vw] bg-sky-800/10 rounded-full blur-[100px]" />
             </>
          )}
          ...
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
              ...
              <motion.div 
                ...
                animate={{ opacity: 1, x: 0 }} // Usamos animate para que pinte de inmediato (Mejora LCP)
              ...
              >
                <Image 
                  ...
                  sizes="(max-width: 768px) 100vw, 50vw" // Ayuda al navegador a elegir la versión correcta
                />
                        ...
                        <div className="relative w-24 h-24 mx-auto mb-4">
                          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-white/10 group-hover:border-[#B2904D] transition-all duration-500 shadow-lg">
                            <Image 
                              ...
                              width={96} 
                              height={96}
                              // Optimización: Descarga el tamaño correcto según el dispositivo
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "100px" }} // Carga anticipada antes de llegar al scroll
