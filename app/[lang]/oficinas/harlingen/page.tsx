...
import { MapPin, Clock, Star, CheckCircle2, Sparkles, Play } from 'lucide-react';
...
const officeData = {
  ...
  // Harlingen no tiene managers en la data original
  attorneys: [
...
export default function HarlingenPage() {
