...
const officeData = {
  ...
  mapLink: 'https://www.google.com/maps/search/?api=1&query=2600+South+Shore+Blvd+Suite+329,+League+City,+TX+77573',
  imageUrl: '/offices/League.png',
  services: [
    { es: 'VISA U', en: 'U VISA' }, 
  ...
  managers: [] as TeamMember[],
  attorneys: [] as TeamMember[]
};
        ...
        <div className="relative z-10 pt-[160px] pb-20">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 mb-24">
              ...
              {/* Grid de Equipo (Abogados y Gerentes) - Solo se muestra si hay datos */}
