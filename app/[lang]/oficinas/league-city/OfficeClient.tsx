...
const officeData = {
  ...
  mapLink: 'https://share.google/8T736Tycmnh4BZw5o', // URL CORRECTA DE GMB
  // Usamos el video general o uno específico si existe (fallback al de Houston)
  videoUrl: 'https://manuelsolis.com/wp-content/uploads/2023/12/houston-main.mp4',
  posterImage: '/offices/League.png',
  services: [
    { es: 'VISA U', en: 'U VISA' }, 
  ...
  // --- GERENCIA (VACÍO PERO TIPADO) ---
  managers: [] as { name: string; role: { es: string; en: string }; image?: string }[],
  
  // --- ABOGADOS (VACÍO PERO TIPADO - Asumimos que se llenará luego o no hay específicos) ---
  attorneys: [] as { name: string; role: { es: string; en: string }; image?: string; quote?: { es: string; en: string } }[]
};
        ...
        <div className="relative z-10 pt-[160px] pb-20">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#B2904D]/10 border border-[#B2904D]/30 mb-6">
                  ...
                  <span className="text-[#B2904D] text-xs font-bold tracking-[0.2em] uppercase">League City, Texas</span>
                </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 mb-24">
              ...
              {/* Grid de Equipo - Solo se muestra si hay datos */}
