...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas`,
      images: [
        {
          url: imageUrl, 
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas`,
      languages: {
        'es': `${SITE_URL}/es/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas`,
        'en': `${SITE_URL}/en/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas`,
        'x-default': `${SITE_URL}/es/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('perdon-i-192-como-arreglar-con-la-visa-u-si-tienes-deportaciones-previas', (lang as 'es' | 'en') || 'es')}
