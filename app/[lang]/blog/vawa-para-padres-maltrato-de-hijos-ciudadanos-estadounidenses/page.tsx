...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const social = buildSocialMetadata({
    lang: lang === 'en' ? 'en' : 'es',
    path: `/${lang}/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses`,
    title: t.title,
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses`,
      languages: {
        'es': `${SITE_URL}/es/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses`,
        'en': `${SITE_URL}/en/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses`,
        'x-default': `${SITE_URL}/es/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses', (lang as 'es' | 'en') || 'es')}
