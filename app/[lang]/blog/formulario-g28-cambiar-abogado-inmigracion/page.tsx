...
const blogContent = {
  es: {
    ...
    metaDesc: '¿Quieres cambiar de abogado de inmigración? Aprende cómo funciona el Formulario G-28 y cómo notificar a USCIS sin poner en riesgo tu proceso migratorio.',
    ui: {
      back: 'Volver al blog',
  ...
  en: {
    metaTitle: 'Form G-28: How to Change Your Immigration Attorney Safely',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const social = buildSocialMetadata({
    lang: lang === 'en' ? 'en' : 'es',
    path: `/${lang}/blog/formulario-g28-cambiar-abogado-inmigracion`,
    title: t.title,
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/formulario-g28-cambiar-abogado-inmigracion`,
      languages: {
        'es': `${SITE_URL}/es/blog/formulario-g28-cambiar-abogado-inmigracion`,
        'en': `${SITE_URL}/en/blog/formulario-g28-cambiar-abogado-inmigracion`,
        'x-default': `${SITE_URL}/es/blog/formulario-g28-cambiar-abogado-inmigracion`,
      },
    },
  };
}
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('formulario-g28-cambiar-abogado-inmigracion', (lang as 'es' | 'en') || 'es')}
