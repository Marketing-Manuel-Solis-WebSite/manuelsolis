...
const IMAGES = {
  article: '/blog/blog_25/B5_CR1.png',
  inside1: '/blog/blog_25/B5_CR2.png',
  inside2: '/blog/blog_25/B5_CR2.png',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/accidente-auto-indocumentado-derechos`,
      images: [
        {
          url: imageUrl,
          width: 1200,
