...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/VAWA_para_padres_Maltrato_de_hijos_ciudadanos_estadounidenses`,
      languages: {
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/VAWA_para_padres_Maltrato_de_hijos_ciudadanos_estadounidenses` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('VAWA_para_padres_Maltrato_de_hijos_ciudadanos_estadounidenses', (lang as 'es' | 'en') || 'es')}
