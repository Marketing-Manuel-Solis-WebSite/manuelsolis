...
const IMAGES = {
  article: '/blog/blog_29/B9_CR1.png',
  inside1: '/blog/blog_29/B9_CR2.png',
  inside2: '/blog/blog_29/B9_CR2.png',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/familias-estatus-mixto-opciones`,
      images: [
        {
          url: imageUrl,
          width: 1200,
      ...
      type: 'article',
      publishedTime: '2025-05-12T08:00:00.000Z',
