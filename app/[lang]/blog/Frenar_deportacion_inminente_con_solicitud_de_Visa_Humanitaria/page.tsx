...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/Frenar_deportacion_inminente_con_solicitud_de_Visa_Humanitaria`,
      images: [
        {
          url: imageUrl, 
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/Frenar_deportacion_inminente_con_solicitud_de_Visa_Humanitaria`,
      languages: {
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/Frenar_deportacion_inminente_con_solicitud_de_Visa_Humanitaria` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('Frenar_deportacion_inminente_con_solicitud_de_Visa_Humanitaria', (lang as 'es' | 'en') || 'es')}
