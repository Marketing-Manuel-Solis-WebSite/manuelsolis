...
const IMAGES = {
  article: '/blog/blog_21/B1_CR1.png',
  inside1: '/blog/blog_21/B1_CR2.png',
  inside2: '/blog/blog_21/B1_CR2.png',
  author: '/abogado-manuel-solis.jpg'
};

const blogContent = {
  es: {
    metaTitle: 'TPS 2026: Países Elegibles, Renovación y Qué Hacer si tu País Fue Terminado',
  ...
  en: {
    metaTitle: 'TPS 2026: Eligible Countries, Renewal, and What to Do If Your Country Was Terminated',
