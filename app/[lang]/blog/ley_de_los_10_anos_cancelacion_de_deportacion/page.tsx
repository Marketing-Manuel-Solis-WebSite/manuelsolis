...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/ley_de_los_10_anos_cancelacion_de_deportacion`,
      images: [
        {
          url: imageUrl,
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/ley_de_los_10_anos_cancelacion_de_deportacion`,
      languages: {
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/ley_de_los_10_anos_cancelacion_de_deportacion` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('ley_de_los_10_anos_cancelacion_de_deportacion', (lang as 'es' | 'en') || 'es')}
