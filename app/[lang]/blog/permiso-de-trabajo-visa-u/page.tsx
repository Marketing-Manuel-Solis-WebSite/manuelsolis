...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/permiso-de-trabajo-visa-u`,
      images: [
        {
          url: imageUrl, 
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/permiso-de-trabajo-visa-u`,
      languages: {
        'es': `${SITE_URL}/es/blog/permiso-de-trabajo-visa-u`,
        'en': `${SITE_URL}/en/blog/permiso-de-trabajo-visa-u`,
        'x-default': `${SITE_URL}/es/blog/permiso-de-trabajo-visa-u`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/permiso-de-trabajo-visa-u` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('permiso-de-trabajo-visa-u', (lang as 'es' | 'en') || 'es')}
