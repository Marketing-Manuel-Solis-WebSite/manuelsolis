...
const IMAGES = {
  article: '/blog/blog_30/B10_CR1.png',
  inside1: '/blog/blog_30/B10_CR2.png',
  inside2: '/blog/blog_30/B10_CR2.png',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/fraude-notarios-inmigracion`,
      images: [
        {
          url: imageUrl,
          width: 1200,
      ...
      type: 'article',
      publishedTime: '2025-05-16T08:00:00.000Z',
