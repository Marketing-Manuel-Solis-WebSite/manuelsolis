...
const blogContent = {
  es: {
    metaTitle: 'Asilo en la frontera 2026: ingresar vs cruzar sin autorizaci\u00f3n | Manuel Sol\u00eds',
  ...
  en: {
    metaTitle: 'Asylum at the Border 2026: Port of Entry vs Unauthorized Crossing | Manuel Sol\u00eds',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`,
      images: [
        {
          url: imageUrl,
          width: 1200,
      ...
      type: 'article',
      publishedTime: '2025-04-04T08:00:00.000Z',
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`,
      languages: {
        'es': `${SITE_URL}/es/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`,
        'en': `${SITE_URL}/en/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`,
        'x-default': `${SITE_URL}/en/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articleSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `${SITE_URL}/${lang}/blog/asilo_frontera_2026_puerto_entrada_vs_cruce`
    }
  };
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/asilo_frontera_2026_puerto_entrada_vs_cruce` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('asilo_frontera_2026_puerto_entrada_vs_cruce', (lang as 'es' | 'en') || 'es')}
