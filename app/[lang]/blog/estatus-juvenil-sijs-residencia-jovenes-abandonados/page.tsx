...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados`,
      images: [
        {
          url: imageUrl,
          width: 1200,
      ...
      type: 'article',
      publishedTime: '2026-03-17T08:00:00.000Z',
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados`,
      languages: {
        'es': `${SITE_URL}/es/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados`,
        'en': `${SITE_URL}/en/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados`,
        'x-default': `${SITE_URL}/es/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/estatus-juvenil-sijs-residencia-jovenes-abandonados` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('estatus-juvenil-sijs-residencia-jovenes-abandonados', (lang as 'es' | 'en') || 'es')}
