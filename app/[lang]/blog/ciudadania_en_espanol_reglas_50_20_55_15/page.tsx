...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/ciudadania_en_espanol_reglas_50_20_55_15`,
      images: [
        {
          url: imageUrl,
          width: 1200,
      ...
      type: 'article',
      publishedTime: '2025-03-28T08:00:00.000Z',
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/ciudadania_en_espanol_reglas_50_20_55_15`,
      languages: {
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/ciudadania_en_espanol_reglas_50_20_55_15` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('ciudadania_en_espanol_reglas_50_20_55_15', (lang as 'es' | 'en') || 'es')}
