...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        'es': `${SITE_URL}/es/blog/residencia-laboral-eb3-ley-245i-entrada-indocumentada`,
        'en': `${SITE_URL}/en/blog/residencia-laboral-eb3-ley-245i-entrada-indocumentada`,
        'x-default': `${SITE_URL}/es/blog/residencia-laboral-eb3-ley-245i-entrada-indocumentada`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/residencia-laboral-eb3-ley-245i-entrada-indocumentada` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('residencia-laboral-eb3-ley-245i-entrada-indocumentada', (lang as 'es' | 'en') || 'es')}
