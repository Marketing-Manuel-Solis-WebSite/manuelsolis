...
const blogContent = {
  es: {
    metaTitle: 'Visa U y VAWA: Incluir hijos y cónyuges derivados | Manuel Solís',
  ...
  en: {
    metaTitle: 'U Visa & VAWA: Including Children and Spouses as Derivatives | Manuel Solís',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/Visa_U_y_VAWA_incluir_hijos_y_nuevos_esposos_derivados`,
      images: [
        {
          url: imageUrl, 
          width: 1200,
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articleSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `${SITE_URL}/${lang}/blog/Visa_U_y_VAWA_incluir_hijos_y_nuevos_esposos_derivados`
    }
  };
