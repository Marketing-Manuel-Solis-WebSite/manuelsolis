...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  const social = buildSocialMetadata({
    lang: lang === 'en' ? 'en' : 'es',
    path: `/${lang}/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u`,
    title: t.title,
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u`,
      languages: {
        'es': `${SITE_URL}/es/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u`,
        'en': `${SITE_URL}/en/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u`,
        'x-default': `${SITE_URL}/es/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/que-hacer-si-la-policia-no-firma-la-certificacion-visa-u` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('que-hacer-si-la-policia-no-firma-la-certificacion-visa-u', (lang as 'es' | 'en') || 'es')}
