...
const blogContent = {
  es: {
    metaTitle: 'Advance Parole 2026: viajar con DACA o TPS | Manuel Solís',
  ...
  en: {
    metaTitle: 'Advance Parole 2026: Traveling with DACA or TPS | Manuel Solís',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`,
      images: [
        {
          url: imageUrl,
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`,
      languages: {
        'es': `${SITE_URL}/es/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`,
        'en': `${SITE_URL}/en/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`,
        'x-default': `${SITE_URL}/en/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articleSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `${SITE_URL}/${lang}/blog/advance_parole_2026_viajar_con_daca_tps_visa_u`
    }
  };
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/advance_parole_2026_viajar_con_daca_tps_visa_u` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('advance_parole_2026_viajar_con_daca_tps_visa_u', (lang as 'es' | 'en') || 'es')}
