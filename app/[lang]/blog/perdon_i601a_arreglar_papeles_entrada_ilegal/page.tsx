...
const blogContent = {
  es: {
    metaTitle: 'Perdón I-601A: Cómo arreglar papeles si entraste ilegalmente | Manuel Solís',
  ...
  en: {
    metaTitle: 'I-601A Waiver: How to Fix Papers After Illegal Entry | Manuel Solís',
...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: t.title,
      description: t.metaDesc,
      url: `${SITE_URL}/${lang}/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`,
      images: [
        {
          url: imageUrl,
          width: 1200,
    ...
    alternates: {
      canonical: `${SITE_URL}/${lang}/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`,
      languages: {
        'es': `${SITE_URL}/es/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`,
        'en': `${SITE_URL}/en/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`,
        'x-default': `${SITE_URL}/en/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`,
      },
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const articleSchema = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `${SITE_URL}/${lang}/blog/perdon_i601a_arreglar_papeles_entrada_ilegal`
    }
  };
  ...
  const breadcrumbData = generateBreadcrumbSchema([
    ...
    { name: t.title, url: `/${lang}/blog/perdon_i601a_arreglar_papeles_entrada_ilegal` },
  ]);
    ...
    <>
      ...
      <div className={`min-h-screen bg-[#001540] text-white selection:bg-[#B2904D] selection:text-[#001540]`}>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <RelatedContent
            articles={getRelatedArticles('perdon_i601a_arreglar_papeles_entrada_ilegal', (lang as 'es' | 'en') || 'es')}
