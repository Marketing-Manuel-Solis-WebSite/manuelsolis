...
const faqDataBilingual = {
  ...
  insuranceLaw: [
    ...
    },
    {
      ...
      content: { es: "Puede que no sea cierto. Busque la opinión de una empresa de restauración de buena reputación o un profesional calificado. Si la pérdida está relacionada con un incendio, el daño por calor, humo y agua puede ser significativo si los artículos no se consumieron totalmente en el incendio. El olor a humo es difícil de eliminar y es una simplificación excesiva y conveniente para el ajustador con el fin de que afirme o espere que se limpien los artículos dañados. En las Oficinas del Abogado Manuel Solís, podemos **revisar los daños** que ha sufrido para poder así negociar en su nombre con el ajustador de su compañía de seguros y que no le engañen.", en: "It may not be true. Seek the opinion of a reputable **restoration company** or a qualified professional. If the loss is fire-related, heat, smoke, and water damage can be significant if items were not totally consumed in the fire. Smoke odor is difficult to eliminate and it is an oversimplification and convenient for the adjuster to claim or expect damaged items to be cleaned. In the Law Offices of Attorney Manuel Solís, we can **review the damages** you have suffered so we can negotiate on your behalf with your insurance company's adjuster and ensure you are not misled." },
    },
    {
      ...
      content: { es: "Debe **consultar con un abogado** para determinar si tiene o no derecho a cobrar una indemnización por daños. A veces, los seguros intentarán pagar lo menos posible ante un siniestro, por eso es una buena idea asesorarse profesionalmente. En las Oficinas del Abogado Manuel Solís, podemos **valorar los daños** que ha sufrido y trabajamos bajo contingencia: sólo cobramos el servicio de representación si usted obtiene una indemnización. La cantidad es un porcentaje sobre lo que ha recibido y el porcentaje dependerá de si vamos a corte o no.", en: "You should **consult with an attorney** to determine whether or not you are entitled to collect compensation for damages. Sometimes, insurance companies will try to pay as little as possible in the event of a claim, so it is a good idea to seek professional advice. At the Law Offices of Attorney Manuel Solís, we can **review the damages** you have suffered, and we work on contingency: we only charge for our representation service if you obtain compensation. The amount is a percentage of what you receive, and the percentage will depend on whether we go to court or not." },
    },
  ] as FaqItemBilingual[],
};
