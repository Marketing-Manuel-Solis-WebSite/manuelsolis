...
import ShortLinksDashboard from './ShortLinksDashboard';

export const metadata: Metadata = {
  title: 'Short Links · Atribución — Manuel Solis Law',
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
export default async function ShortLinksPage({ params, searchParams }: Props) {
  ...
  return <ShortLinksDashboard lang={lang} />;
}
