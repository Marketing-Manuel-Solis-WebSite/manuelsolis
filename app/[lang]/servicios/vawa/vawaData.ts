...
const blogArticles: { slug: string; title: Detail; category: Detail; image: string }[] = [
  { slug: 'vawa-para-hombres-maltratados-por-pareja-ciudadana-o-residente', title: { es: 'VAWA para Hombres Maltratados por Pareja Ciudadana o Residente', en: 'VAWA for Men Abused by Citizen or Resident Partners' }, category: { es: 'VAWA', en: 'VAWA' }, image: '/blog/blog_06/B6_CR1.png' },
  { slug: 'vawa-para-padres-maltrato-de-hijos-ciudadanos-estadounidenses', title: { es: 'VAWA para Padres: Maltrato de Hijos Ciudadanos', en: 'VAWA for Parents: Abuse by Citizen Children' }, category: { es: 'VAWA', en: 'VAWA' }, image: '/blog/blog_05/B5_CR1.png' },
  { slug: 'visa-u-y-vawa-incluir-hijos-y-nuevos-esposos-derivados', title: { es: 'Visa U y VAWA: Incluir Hijos y Nuevos Esposos Derivados', en: 'U Visa & VAWA: Including Children and New Derivative Spouses' }, category: { es: 'VAWA / Visa U', en: 'VAWA / U Visa' }, image: '/blog/blog_10/B10_CR1.png' },
];
