...
const getAccidentesFAQs = (lang: string) => {
  const faqs = lang === 'es' ? [
    ...
    { question: '¿Cobran por la consulta inicial?', answer: 'No. Ofrecemos consulta gratuita y trabajamos bajo contingencia, lo que significa que no paga nada a menos que ganemos su caso. Solo cobramos un porcentaje de la compensación que usted reciba.' },
  ] : [
    ...
    { question: 'Do you charge for the initial consultation?', answer: 'No. We offer a free consultation and work on contingency, which means you pay nothing unless we win your case. We only charge a percentage of the compensation you receive.' },
  ];
  return faqs;
};
