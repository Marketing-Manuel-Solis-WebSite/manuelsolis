      ...
      <div className="relative z-10 pt-24 md:pt-28 px-4">
        <div className="container mx-auto max-w-7xl">
          <Breadcrumbs items={[
            ...
            { label: { es: 'Ley Criminal', en: 'Criminal Law' }, href: `/${language}/servicios/ley-criminal` },
          ]} />
        </div>
      </div>
                 ...
                 <div className="relative z-10 w-full h-full flex items-center justify-center transform-gpu">
                    <div className="relative w-full h-full">
                       <Image
                         ...
                         alt="Abogado de defensa criminal y consecuencias migratorias en Houston, Texas"
                         fill
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                title: { es: 'Perdón I-192: arreglar con Visa U con deportaciones previas', en: 'I-192 Waiver: Fix with U Visa Despite Prior Deportations' },
