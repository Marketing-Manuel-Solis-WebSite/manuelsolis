...
const blogArticles: { slug: string; title: Detail; category: Detail; image: string }[] = [
  ...
  { slug: 'Frenar_deportacion_inminente_con_solicitud_de_Visa_Humanitaria', title: { es: 'Parar deportación urgente con Visa U o VAWA pendiente', en: 'Stop Urgent Deportation with Pending U Visa or VAWA' }, category: { es: 'Deportación', en: 'Deportation' }, image: '/blog/blog_8/BLOG08_CR1.png' },
