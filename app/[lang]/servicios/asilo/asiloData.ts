...
const blogArticles: { slug: string; title: Detail; category: Detail; image: string }[] = [
  ...
  { slug: 'estatus-juvenil-sijs-residencia-jovenes-abandonados', title: { es: 'Estatus Juvenil SIJS: papeles para jóvenes', en: 'SIJS: Papers for Abandoned Youth' }, category: { es: 'Humanitario', en: 'Humanitarian' }, image: '/blog/blog_15/BLOG05_CR1.png' },
];
