...
import AsiloCases from './AsiloCases';
import { resolveTabs, resolveSteps, resolveBlog, getOffices, resolveUi, type StepIconKey } from './asiloData';
import type { Language } from '../../../lib/translations';

const STEP_ICONS: Record<StepIconKey, ElementType> = { search: Search, fileText: FileText, send: Send, shield: Shield };

/**
 * Asylum page — server-first (Fase 2.3 Lote C, enfoque b). Image hero + tabs
    ...
    <div className="min-h-screen flex flex-col bg-navy-500 text-white relative selection:bg-[#B2904D] selection:text-white font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none w-full h-full transform-gpu">
        ...
        <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none select-none overflow-hidden">
          <span className="text-[15vw] font-black italic text-white tracking-tighter transform -skew-x-12 whitespace-nowrap">ASILO</span>
        </div>
      </div>
      ...
      <main id="main-content" tabIndex={-1}>
        <div className="relative z-10 pt-24 md:pt-28 px-4">
          <div className="container mx-auto max-w-7xl">
            <Breadcrumbs items={[
              ...
              { label: { es: 'Asilo Político', en: 'Political Asylum' }, href: `/${lang}/servicios/asilo` },
            ]} />
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              <div className="lg:col-span-5 relative h-[450px] md:h-[600px] lg:h-[80vh] flex items-end justify-center order-2 lg:order-1">
                ...
                <div className="relative z-0 w-full h-full flex items-end justify-center">
                  <Image src="/home-image.jpg" alt={isEs ? 'Abogados de Asilo - Protección internacional para perseguidos' : 'Asylum Attorneys - International protection for the persecuted'} fill className="object-contain object-bottom drop-shadow-[0_0_35px_rgba(178,144,77,0.25)]" priority sizes="(max-width: 768px) 100vw, 50vw" />
                </div>
                <Reveal variant="up" delay={0.3} className="absolute bottom-32 lg:bottom-48 -right-4 md:-right-10 z-20 p-6 border border-[#B2904D]/30 rounded-2xl backdrop-blur-xl bg-[#001540]/60 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <span className="text-[#B2904D] font-bold tracking-widest text-xs uppercase">{ui.protection}</span>
                  </div>
              ...
              <div className="lg:col-span-7 space-y-8 pl-0 lg:pl-8 relative z-20 order-1 lg:order-2 flex flex-col justify-center items-start">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#B2904D]/30 bg-[#B2904D]/10 backdrop-blur-sm shadow-[0_0_15px_rgba(178,144,77,0.1)] self-start">
                  ...
                  <span className="text-[#B2904D] text-xs font-bold tracking-[0.2em] uppercase">{ui.heroBadge}</span>
                </div>
                ...
                <Reveal variant="up" delay={0.2} className="flex flex-wrap gap-4 pt-4">
                  ...
                  <a href="tel:+18325980914" className="px-8 py-4 border-2 border-white/20 hover:border-[#B2904D]/50 text-white font-bold rounded-xl transition-all flex items-center gap-3 group text-base backdrop-blur-sm">
                    ...
                    <span className="sm:hidden">{ui.ctaLlamar}</span>
                  </a>
                </Reveal>
              </div>
            </div>
        ...
        <AsiloCases tabs={tabs} requestEvaluation={ui.requestEvaluation} />
        ...
        <section className="py-24 relative overflow-hidden bg-[#001f5f]/30 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <Reveal variant="up" className="text-center mb-16" amount={0.4}>
              <h2 className="text-3xl md:text-4xl font-black text-white mb-4">{ui.officeSectionTitle}</h2>
              <p className="text-blue-100/60 text-lg max-w-3xl mx-auto font-light">{ui.officeSectionSubtitle}</p>
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <Reveal variant="up" className="text-center mb-24" amount={0.4}>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-8">
                ...
                <span className="text-xs font-bold tracking-[0.2em] text-white uppercase">{ui.processTitle}</span>
              </div>
              <h2 className="text-2xl sm:text-4xl md:text-6xl font-black text-white mb-6">{ui.processSubtitle}</h2>
