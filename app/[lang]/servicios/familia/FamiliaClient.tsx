...
import FamiliaCases from './FamiliaCases';
import { resolveCases, resolveSteps, resolveUi, type IconKey } from './familiaData';
import type { Language } from '../../../lib/translations';

const ICONS: Record<IconKey, ElementType> = { phoneCall: PhoneCall, fileText: FileText, messageSquare: MessageSquare, scale: Scale, handCoins: FileText };

/**
 * Family Law page — server-first (Fase 2.3 Lote A, enfoque b). LCP sacred:
    ...
    <div className="min-h-screen flex flex-col bg-navy-500 text-white relative selection:bg-[#B2904D] selection:text-white font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none w-full h-full transform-gpu">
        ...
        <div aria-hidden="true" className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none select-none overflow-hidden">
          <span className="text-[120vh] font-black italic text-white tracking-tighter whitespace-nowrap">FAMILIA</span>
        </div>
      </div>
      ...
      <main id="main-content" tabIndex={-1}>
        <div className="relative z-10 pt-24 md:pt-28 px-4">
          <div className="container mx-auto max-w-7xl">
            <Breadcrumbs items={[
              ...
              { label: { es: 'Familia', en: 'Family' }, href: `/${lang}/servicios/familia` },
            ]} />
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-center">
              <div className="lg:col-span-5 relative h-[300px] sm:h-[400px] md:h-[600px] lg:h-[700px] flex items-center justify-center order-2 lg:order-1">
                ...
                <div className="relative z-10 w-full h-full flex items-center justify-center transform-gpu">
                  <div className="relative w-full h-full">
                    <Image src="/family-hero.png" alt={isEs ? 'Un adulto y un niño caminando de la mano hacia una puerta de vidrio iluminada' : 'An adult and a child walking hand in hand toward a bright glass doorway'} fill className="object-contain object-center drop-shadow-[0_0_20px_rgba(56,189,248,0.5)]" priority sizes="(max-width: 768px) 100vw, 50vw" />
                  </div>
                </div>
              ...
              <div className="lg:col-span-7 space-y-6 md:space-y-8 pl-0 lg:pl-12 relative z-20 order-1 lg:order-2">
                ...
                <Reveal as="div" variant="up" delay={0.15} className="relative pl-6 border-l-2 border-[#B2904D]/50">
                  <p className="text-xl md:text-2xl text-white/80 font-light leading-relaxed">{ui.heroDescription}</p>
                </Reveal>
        ...
        <FamiliaCases cases={cases} ui={ui} />
