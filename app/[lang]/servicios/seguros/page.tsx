...
const getSegurosFAQs = (lang: string) => {
  const faqs = lang === 'es' ? [
    ...
    { question: '¿Cuánto cuesta contratar un abogado para un caso de seguros?', answer: 'Trabajamos bajo contingencia en la mayoría de los casos de seguros, lo que significa que no paga nada por adelantado. Solo cobramos si ganamos su caso. La consulta inicial es completamente gratuita para evaluar si tiene un caso viable.' },
  ] : [
    ...
    { question: 'How much does it cost to hire a lawyer for an insurance case?', answer: 'We work on contingency for most insurance cases, meaning you pay nothing upfront. We only charge if we win your case. The initial consultation is completely free to evaluate if you have a viable case.' },
  ];
  return faqs;
};
